...

{
    ...
    { 17, 4, 5, 0 },
    10, 18, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SCREECH,
...

{
    ...
    { 16, 6, 2, 0 },
    3, 2, MST_DRACONIAN_KNIGHT, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...

{
    ...
    { 20, 5, 5, 0 },
    10, 15, MST_BLINKER, CE_CLEAN, Z_SMALL, S_SHOUT,
...

{
    ...
    mrd(MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 2)
        | MR_RES_PETRIFY,
    0, 10, MONS_STATUE, MONS_OBSIDIAN_STATUE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 0, 0, 70 },
    12, 1, MST_OBSIDIAN_STATUE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID
},
...
// "D"ragons and hydras.
{
    ...
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 17},
      {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK },
    { 19, 0, 0, 133 },
    15, 7, MST_XTAHUA, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_NORMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
