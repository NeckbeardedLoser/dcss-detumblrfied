...

{
    ...
    { {AT_CLAW, AF_ACID, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 17, 4, 5, 0 },
    10, 18, MST_NO_SPELLS, CE_CLEAN, S_SCREECH,
    I_NORMAL, HT_LAND, FL_WINGED, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY, MON_SHAPE_BAT
},
...

{
    ...
    { 6, 1, 2, 0 },
    5, 20, MST_BLINKER, CE_NOCORPSE, S_MOAN,
...
// lava monsters
{
    ...
    { 3, 3, 5, 0 },
    2, 17, MST_NO_SPELLS, CE_CLEAN, S_HISS,
...
// "A"ngels.
{
    ...
    M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_GLOWS_LIGHT | M_UNIQUE,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2),
...
// "c"entaurs.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_ARCHER | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
    1800, 18, MONS_DRAGON, MONS_SERPENT_OF_HELL, MH_DEMONIC, 180,
    { {AT_BITE, AF_REACH, 50}, {AT_CLAW, AF_PLAIN, 25},
      {AT_TRAMPLE, AF_PLAIN, 25}, {AT_TAIL_SLAP, AF_PLAIN, 15} },
    { 20, 0, 0, 400 },
    30, 12, MST_SERPENT_OF_HELL, CE_NOCORPSE, S_ROAR,
...
// "F"rogs.
{
    ...
    M_UNIQUE | M_COLD_BLOOD | M_SPEAKS
        | M_PHASE_SHIFT,
    MR_NO_FLAGS,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_NO_REGEN,
    MR_NO_FLAGS,
...
// "h" - carnivorous quadrupeds
{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_UNIQUE,
    MR_NO_FLAGS,
...
// "H"ybrids.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_WEB_SENSE,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_UNIQUE,
    MR_NO_FLAGS,
...

{
    ...
    M_HYBRID | M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_UNIQUE,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_UNIQUE | M_PHASE_SHIFT,
    MR_RES_FIRE | MR_RES_COLD,
...
// Snails and other gastropods.
{
    ...
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_NO_WAND,
    MR_NO_FLAGS,
...
// "K"obolds.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    M_ARTIFICIAL | M_UNIQUE | M_STATIONARY | M_SPEAKS | M_NO_WAND,
    mrd(MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 2)
        | MR_RES_PETRIFY,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD
        | M_SPEAKS,
    MR_NO_FLAGS,
    550, 20, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SEE_INVIS
        | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
    MR_NO_FLAGS,
